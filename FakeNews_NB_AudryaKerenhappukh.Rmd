...
author: "Audrya Kerenhappukh (Author) and Ryan Kokke (Reviewer)"
...
Before we can start modelling, it is important to split the datasets into train and test sets. 
...
# Visualization if Confusion Matrix 
```{r}
